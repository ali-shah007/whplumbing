      ...
      <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-gray-300 mb-8 max-w-lg">
            Fast, reliable boiler repairs with same-day availability. 
            We fix all major brands with honest pricing and no hidden costs.
          </p>

          {/* Trust Points */}
          <div className="grid grid-cols-2 gap-3 mb-10 text-sm">
            <span className="bg-white/5 border border-white/10 px-3 py-2 rounded-lg">🔥 Fast repairs</span>
            <span className="bg-white/5 border border-white/10 px-3 py-2 rounded-lg">✔ Gas Safe engineers</span>
            <span className="bg-white/5 border border-white/10 px-3 py-2 rounded-lg">💰 Fixed pricing</span>
